...
#### these are all .env info for my development purpose

NODE_ENV= development
PORT=5000
DATABASE_URL=mongodb+srv://iRepair:qQMUNRoHIVjAayAW@cluster0.kqpbf9w.mongodb.net/irepair?retryWrites=true&w=majority
